...
-- Utility Functions
--=====================================================================================
local muteSoundIDs = {12345, 67890} -- Example sound IDs to mute
...
function RU:MAJOR_FACTION_RENOWN_LEVEL_CHANGED()
    if functionsHalted then return end
    if debugMode then
        self:DebugMessage("[|cff3bbc00RU|r] [|cff808080DEBUG|r] |cffc586c0MAJOR_FACTION_RENOWN_LEVEL_CHANGED|r event triggered.")
    end
...
-- Test Functions
--=====================================================================================
function RU:TestRenownSound()
    if debugMode then
        self:DebugMessage("[|cff3bbc00RU|r] [|cff808080DEBUG|r] |cffc586c0TestRenownSound|r event triggered.")
    end
    local sound = SelectSound(RU.db.profile.RenownSoundSelect)
    local volumeLevel = RU.db.profile.RenownVolume
    PlaySelectedSound(sound, volumeLevel, defaultSounds[5])
